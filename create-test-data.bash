...
do
   ...
   do
      ...
      echo "INSERT INTO reminder (tenantId, issueId, originalIssueKey, issueKey, originalIssueSummary, issueSummary, userKey, userEmail, message, date) VALUES ($tenantId, $RANDOM, 'ORIGINAL-ISSUE-$RANDOM', 'ISSUE-$RANDOM', 'ORIGINAL-$SUMMARY', '$SUMMARY', '$USER_KEY', '$USER_MAIL', '$USER_MESSAGE', current_timestamp + interval '$HOURS_INTERVAL hours');" >> "$CREATE_FILE" 
   done
done
